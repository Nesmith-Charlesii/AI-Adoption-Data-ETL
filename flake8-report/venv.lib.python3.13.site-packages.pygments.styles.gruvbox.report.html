...
<html>
   <head>
      <title>flake8 violations: .venv/lib/python3.13/site-packages/pygments/styles/gruvbox.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.13.site-packages.pygments.styles.gruvbox.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.13.site-packages.pygments.styles.gruvbox.source.html#l24">
                  <tt><i>24</i>     </tt>
               </a>
            </li>
            </ul>
