...
<html>
   <head>
      <title>flake8 violations: .venv/lib/python3.13/site-packages/pygments/styles/staroffice.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.13.site-packages.pygments.styles.staroffice.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.13.site-packages.pygments.styles.staroffice.source.html#l25">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.13.site-packages.pygments.styles.staroffice.source.html#l24">
                  <tt><i>24</i>     </tt>
               </a>
            </li>
            </ul>
