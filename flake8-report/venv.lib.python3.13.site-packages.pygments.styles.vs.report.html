...
<html>
   <head>
      <title>flake8 violations: .venv/lib/python3.13/site-packages/pygments/styles/vs.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.13.site-packages.pygments.styles.vs.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.13.site-packages.pygments.styles.vs.source.html#l21">
                  <tt><i>21</i>     </tt>
               </a>
            </li>
            </ul>
