...
<html>
   <head>
      <title>flake8 violations: .venv/lib/python3.13/site-packages/pygments/styles/vim.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.13.site-packages.pygments.styles.vim.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.13.site-packages.pygments.styles.vim.source.html#l25">
                  <tt><i>25</i>     </tt>
               </a>
            </li>
            </ul>
