...
<html>
   <head>
      <title>flake8 violations: .venv/lib/python3.13/site-packages/pandas/tests/arithmetic/common.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.13.site-packages.pandas.tests.arithmetic.common.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.13.site-packages.pandas.tests.arithmetic.common.source.html#l135">
